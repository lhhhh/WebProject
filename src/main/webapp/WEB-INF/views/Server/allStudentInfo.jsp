  ...
  <body>
  	<script type="text/javascript">
  		function search(){
  			...
  			$.ajax({
  			   type: "POST",
  			   url: "${ctx}/student/searchStudent4Server.do",
  			   data: formArray,
  			   /* data: "stuName=张三", */
  	...
  	<div class="jumbotron">
        <form id="form" action="${ctx}/student/searchStudent4Server.do" method="post">
				...
				<tbody>
					<c:forEach items="${stus}" var="stu">
						<tr>
							...
							<td>
								<a href="initStudent4Server.do?stuNo=${stu.stuNo}"><button type="button" class="btn btn-warning">修改</button></a>
								<a href="deleteStudent4Server.do?stuNo=${stu.stuNo}"><button type="button" class="btn btn-danger">删除</button></a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
		...
		<p><a href="${ctx}/index.jsp" class="btn btn-primary btn-lg" role="button">返回首页 »</a></p>
	</div>
  </body>
</html>
